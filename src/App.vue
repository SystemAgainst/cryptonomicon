...
export default {
  ...
  computed: {
    startIndex() {
      return (this.page - 1) * this.countTicker;
    },

    endIndex() {
      return this.page* this.countTicker;
    },
  ...
  watch: {
    ...
    paginatedTickers() {
      if (this.paginatedTickers.location === 0 && this.page > 1) {
        this.page -= 1;
      }
    },
    ...
    pageStateOptions(value) {
      ...
      const url = `${pathname}?filter=${value.filter}&page=${value.page}`;
